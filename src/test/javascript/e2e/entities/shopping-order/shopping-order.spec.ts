...
describe('ShoppingOrder e2e test', () => {
  ...
  it('should load ShoppingOrders', async () => {
    ...
    expect(await shoppingOrderComponentsPage.getTitle()).to.eq('jHipster6Java11TestApp.shoppingOrder.home.title');
  });
  ...
  it('should load create ShoppingOrder page', async () => {
    ...
    expect(await shoppingOrderUpdatePage.getPageTitle()).to.eq('jHipster6Java11TestApp.shoppingOrder.home.createOrEditLabel');
  ...
  /* it('should delete last ShoppingOrder', async () => {
        ...
        expect(await shoppingOrderDeleteDialog.getDialogTitle())
            .to.eq('jHipster6Java11TestApp.shoppingOrder.delete.question');
