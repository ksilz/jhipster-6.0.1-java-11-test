...
describe('Product e2e test', () => {
  ...
  it('should load Products', async () => {
    ...
    expect(await productComponentsPage.getTitle()).to.eq('jHipster6Java11TestApp.product.home.title');
  });
  ...
  it('should load create Product page', async () => {
    ...
    expect(await productUpdatePage.getPageTitle()).to.eq('jHipster6Java11TestApp.product.home.createOrEditLabel');
  ...
  /* it('should delete last Product', async () => {
        ...
        expect(await productDeleteDialog.getDialogTitle())
            .to.eq('jHipster6Java11TestApp.product.delete.question');
