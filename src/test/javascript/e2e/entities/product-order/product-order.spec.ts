...
describe('ProductOrder e2e test', () => {
  ...
  it('should load ProductOrders', async () => {
    ...
    expect(await productOrderComponentsPage.getTitle()).to.eq('jHipster6Java11TestApp.productOrder.home.title');
  });
  ...
  it('should load create ProductOrder page', async () => {
    ...
    expect(await productOrderUpdatePage.getPageTitle()).to.eq('jHipster6Java11TestApp.productOrder.home.createOrEditLabel');
  ...
  /* it('should delete last ProductOrder', async () => {
        ...
        expect(await productOrderDeleteDialog.getDialogTitle())
            .to.eq('jHipster6Java11TestApp.productOrder.delete.question');
